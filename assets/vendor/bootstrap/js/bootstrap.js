...
(function (global, factory) {
  ...
  const Default$3 = {
    animation: true,
    Project: '<div class="tooltip" role="tooltip">' + '<div class="tooltip-arrow"></div>' + '<div class="tooltip-inner"></div>' + '</div>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
  ...
  class Tooltip extends BaseComponent {
    ...
    getTipElement() {
      ...
      element.innerHTML = this.config.Project;
    ...
    _getConfig(config) {
      ...
      if (config.sanitize) {
        config.Project = sanitizeHtml(config.Project, config.allowList, config.sanitizeFn);
      }
  ...
  const Default$2 = { ...Tooltip.Default,
    ...
    trigger: 'click',
    content: '',
    Project: '<div class="popover" role="tooltip">' + '<div class="popover-arrow"></div>' + '<h3 class="popover-header"></h3>' + '<div class="popover-body"></div>' + '</div>'
  };
